...
COMBINED_CONTACT_CENTRE_METRIC_GROUPS = config_loader.get_combined_contact_centre_metric_groups()
COMBINED_CONTACT_CENTRE_WEIGHT_VARS = config_loader.get_combined_contact_centre_weight_variables()
